...
import { Pencil, Trash2, ImageIcon, Loader } from "lucide-react"
      ...
      <div className="sticky top-0 z-30 border-b border-border/40 bg-background/80 backdrop-blur-xl">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">View and manage your store categories</p>
          </div>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20">
            <div className="rounded-2xl bg-muted/50 p-12 text-center space-y-3 max-w-md mx-auto">
              ...
              <h3 className="text-lg font-semibold text-foreground">No Categories</h3>
              <p className="text-sm text-muted-foreground">Categories will appear here once created</p>
            </div>
          </div>
        ) : (
              ...
              >
                ...
                <div className="flex items-center gap-2 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200 sm:opacity-100">
                  <Button
                    ...
                    className="h-9 w-9 rounded-lg p-0 bg-blue-50 hover:bg-blue-100 text-blue-600 hover:text-blue-700 transition-colors"
                    title="Edit category"
                  >
                  ...
                  <Button
                    ...
                    className="h-9 w-9 rounded-lg p-0 bg-red-50 hover:bg-red-100 text-red-600 hover:text-red-700 transition-colors"
        ...
        <AlertDialogContent className="max-w-sm rounded-2xl border-border/50">
          ...
          <AlertDialogFooter className="flex-col-reverse gap-2 sm:flex-row">
            ...
            <AlertDialogAction
              ...
              className="h-9 sm:h-10 rounded-lg bg-red-600 text-white hover:bg-red-700 text-xs sm:text-sm"
            >
              Delete
            </AlertDialogAction>
          </AlertDialogFooter>
