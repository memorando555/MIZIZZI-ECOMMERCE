  ...
  return (
    <div className="flex items-center gap-1 sm:gap-2">
      <div className="flex flex-col items-center gap-0.5">
        <div className="bg-white/20 backdrop-blur-md rounded-lg px-2 sm:px-3 py-1 min-w-[40px] sm:min-w-[50px] text-center">
          <span className="text-lg sm:text-2xl font-bold text-white">{String(timeLeft.hours).padStart(2, "0")}</span>
        </div>
        <span className="text-[10px] sm:text-xs text-white/70 font-medium">Hours</span>
      </div>
      <span className="text-xl sm:text-3xl text-white/50 font-light mb-4">:</span>
      <div className="flex flex-col items-center gap-0.5">
        <div className="bg-white/20 backdrop-blur-md rounded-lg px-2 sm:px-3 py-1 min-w-[40px] sm:min-w-[50px] text-center">
          <span className="text-lg sm:text-2xl font-bold text-white">{String(timeLeft.minutes).padStart(2, "0")}</span>
        </div>
        <span className="text-[10px] sm:text-xs text-white/70 font-medium">Mins</span>
      </div>
      <span className="text-xl sm:text-3xl text-white/50 font-light mb-4">:</span>
      <div className="flex flex-col items-center gap-0.5">
        <div className="bg-white/20 backdrop-blur-md rounded-lg px-2 sm:px-3 py-1 min-w-[40px] sm:min-w-[50px] text-center">
          <span className="text-lg sm:text-2xl font-bold text-white">{String(timeLeft.seconds).padStart(2, "0")}</span>
        </div>
        <span className="text-[10px] sm:text-xs text-white/70 font-medium">Secs</span>
      </div>
    </div>
  )
}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-white">
      <div className="container py-6 px-4 sm:px-6 lg:px-8">
        ...
        {/* Premium Flash Sale Banner with Image Carousel */}
