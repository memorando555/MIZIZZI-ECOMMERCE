          ...
          <div className="relative z-10 space-y-3 sm:space-y-4 flex flex-col justify-between h-full">
            ...
            >
              ...
              <div className="flex items-end gap-2">
                ...
                <span className="text-3xl sm:text-4xl font-black bg-gradient-to-r from-yellow-200 to-yellow-100 bg-clip-text text-transparent">Up to 50%</span>
              </div>
            </motion.div>
